...
public class DetailActivity extends AppCompatActivity {
    ...
    private void populateUI(Sandwich sandwich) {
        ...
        // create text field variables and then populate them

        TextView aKATV = findViewById(R.id.also_known_as_tv);
        TextView mainName = findViewById(R.id.sandwich_name_tv);
        TextView place = findViewById(R.id.place_of_origin_tv);
